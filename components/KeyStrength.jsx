...
import { LearnMoreAboutUs } from "./LottieComponents";
import { LottieIcon } from "@/components/LottieComponents";
import AOS from "aos";
...
const KeyStrength = () => {
  ...
  return (
    <div>
      <section className="key_strength container grid grid-cols-12 gap-14 py-20">
        <div className="col-span-6 me-5">
          <div className="flex flex-col justify-center items-start py-6">
            <h4
              ...
              // data-aos-once="true"
              id="trigger"
              className=" text-333 text-f16 font-tahoma-bold uppercase mb-5"
            >
              KEY STRENGTHS
            </h4>
            <h2
              ...
              data-aos-easing="ease-in-out"
              // data-aos-once="true"
              className="text-f48 text-[#131316] font-tahoma-bold mb-6 "
            >
              Your Partner in <br />
            ...
            <p
              ...
              data-aos-easing="ease-in-out"
              data-aos-duration="800"
              className="text-333 text-f16 font-tahoma-regular mb-6"
            >
            ...
            <div className="flex items-center gap-5">
              <button
                ...
                data-aos-easing="ease-in-out"
                data-aos-duration="800"
                className="block w-1/2 bg-[#f00e0e] text-white text-center font-bold px-8 py-3 rounded-full"
              >
                Learn More About Us
              </button>
              <div className="w-1/2">
