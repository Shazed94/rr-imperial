...
export default function ScrollToTop() {
  ...
  return (
    <div ref={scrollToTopButton} className="fixed z-50 p-4 text-white transition-opacity duration-500 bg-red-600 opacity-0 bottom-14 md:bottom-2 right-2" onClick={scrollToTop}>
