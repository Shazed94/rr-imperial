...
const AdminRegionalOffices = () => {
  ...
  const officeEmail = useRef();
  const officeContact = useRef();
  const officeDivision = useRef();
  ...
  const [descPhone, setDescPhone] = useState("");
  ...
  useEffect(() => {
    ...
    read_all_divisions().then((res) => {
      setDivisions(res.data.all_divisions);
    });
  }, []);
  ...
  const storeData = (e) => {
    ...
    formdata.append("regional_division_id", officeDivision.current.value);
    formdata.append("map_link", mapLink.current.value);
    formdata.append("shop_address", descVal);
    formdata.append("email", descEmail);
    formdata.append("contact", descPhone);
  ...
  const updateOffice = (e) => {
    ...
    formdata.append("shop_address", descVal);
    formdata.append("email", descEmail);
    formdata.append("phone", descPhone);
                ...
                <div className="grid grid-cols-12 gap-4">
                  ...
                  <div className="mb-1 flex flex-col gap-6 col-span-12">
                    ...
                    <JoditEditor
                      ...
                      tabIndex={1}
                      value={descEmail}
                      onChange={(newContent) => setDescEmail(newContent)}
                    />
                  </div>
                  ...
                  <div className="mb-1 flex flex-col gap-6 col-span-12">
                    ...
                    <JoditEditor
                      ...
                      tabIndex={1}
                      value={descPhone}
                      onChange={(newContent) => setDescPhone(newContent)}
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-12 gap-4">
                  ...
                  <div className="mb-1 flex flex-col gap-2 col-span-12">
                    ...
                    >
                      <option value="">Select Division</option>
                      {divisions?.map((division) => (
                        <option key={division.id} value={division.id} selected={
                          division.id == editOfficeVal.regional_division_id ? "selected" : ""
                        }>
                          {division?.name}
                        </option>
                      ))}
                  ...
                  <div className="mb-1 flex flex-col gap-2 col-span-12">
                    ...
                    <input
                      id="mapLink"
                      ref={mapLink}
                      defaultValue={editOfficeVal?.map_link}
                      type="text"
                      className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder=" Map Link"
                    />
          ...
          {modalData === "View" && (
            <>
              ...
              <div className="mt-2 flex items-start">
                <b>Address:&nbsp;</b>{Parse(`${singleOfficeInfo?.shop_address}`)}
              </div>
              <div className="mt-2 flex items-start">
                <b>Email:&nbsp;</b>{Parse(`${singleOfficeInfo?.email}`)}
              </div>
              <div className="mt-2 flex items-start">
                <b>Contact:&nbsp;</b>   {Parse(`${singleOfficeInfo?.phone}`)}
              </div>
