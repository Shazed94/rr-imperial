  ...
  return (
    <div className="p-4">
      ...
      <div className="content grid grid-cols-12 gap-8 pt-10 pb-12 text-[#b1b2b9] p-5">
        <div className="col-span-3 rounded-lg shadow-lg bg-gray-50 p-5 flex items-center gap-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button className="px-4 py-3 rounded-lg hover:scale-105 transition-all bg-cyan-700 text-white">
              View All
            </button>
          </div>
        </div>
