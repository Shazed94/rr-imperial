  ...
  return (
    <div>
      ...
      <div className="container flex flex-wrap justify-between py-12">
        <Link href="#" className="" onClick={() => handleOpen("Barishal")}>
          <button className="w-36 px-4 py-4 rounded-xl text-white bg-[#D1D3D4] hover:bg-[#E62020] transition-colors ">
            Barishal
          </button>
        </Link>
        <Link href="#" onClick={() => handleOpen("Chattogram")}>
          <button className="w-36 px-4 py-4 rounded-xl text-white bg-[#D1D3D4] hover:bg-[#E62020] transition-colors ">
            Chattogram
          </button>
        </Link>
        <Link href="#" onClick={() => handleOpen("Dhaka")}>
          <button className="w-36 px-4 py-4 rounded-xl text-white bg-[#D1D3D4] hover:bg-[#E62020] transition-colors ">
            Dhaka
          </button>
        </Link>
        <Link href="#" onClick={() => handleOpen("Khulna")}>
          <button className="w-36 px-4 py-4 rounded-xl text-white bg-[#D1D3D4] hover:bg-[#E62020] transition-colors ">
            Khulna
          </button>
        </Link>
        <Link href="#" onClick={() => handleOpen("Rajshahi")}>
          <button className="w-36 px-4 py-4 rounded-xl text-white bg-[#D1D3D4] hover:bg-[#E62020] transition-colors ">
            Rajshahi
          </button>
        </Link>
        <Link href="#" onClick={() => handleOpen("Rangpur")}>
          <button className="w-36 px-4 py-4 rounded-xl text-white bg-[#D1D3D4] hover:bg-[#E62020] transition-colors ">
            Rangpur
          </button>
        </Link>
        <Link href="#" onClick={() => handleOpen("Mymensingh")}>
          <button className="w-36 px-4 py-4 rounded-xl text-white bg-[#D1D3D4] hover:bg-[#E62020] transition-colors ">
            Mymensingh
          </button>
        </Link>
        <Link href="#" onClick={() => handleOpen("Sylhet")}>
          <button className="w-36 px-4 py-4 rounded-xl text-white bg-[#D1D3D4] hover:bg-[#E62020] transition-colors ">
            Sylhet
          </button>
        </Link>
